...
<table class = "table table-hover table-sm" style = "table-layout: fixed; width: 100%;">
    ...
    <tr>
        <td>
            <button class = "btn btn-primary btn-lg" style = "width: 100%;" value = "${days[0]}" onclick = "showDay0(value)">
                ${days[0]}
                <p>Today</p>
            </button>
        </td>
        <td>
            <button class = "btn btn-primary btn-lg" style = "width: 100%;" value = "${days[1]}" onclick = "showDay1(value)">
                ${days[1]}
                <p style = "text-align: center; font-size: 15px; padding-top: 5px; padding-bottom: 5px;">Tomorrow</p>
            </button>
        </td>
        <td>
            <button class = "btn btn-primary btn-lg" style = "width: 100%;" value = "${days[2]}" onclick = "showDay2(value)">
                ${days[2]}
                <p style = "text-align: center; font-size: 15px; padding-top: 5px; padding-bottom: 5px;"></p>
            </button>
        </td>
        <td>
            <button class = "btn btn-primary btn-lg" style = "width: 100%;" value = "${days[3]}" onclick = "showDay3(value)">
                ${days[3]}
                <p style = "text-align: center; font-size: 15px; padding-top: 5px; padding-bottom: 5px;"></p>
            </button>
        </td>
        <td>
            <button class = "btn btn-primary btn-lg" style = "width: 100%;" value = "${days[4]}" onclick = "showDay4(value)">
                ${days[4]}
                <p style = "text-align: center; font-size: 15px; padding-top: 5px; padding-bottom: 5px;"></p>
            </button>
        </td>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js"
        integrity="sha384-57eA0YAF5fnhV7+ZJ86a8qF4KycIoD+yPp6rWleK3bP4Rl+oG2xzMo+haxQs7Uz0"
        crossorigin="anonymous"></script>
